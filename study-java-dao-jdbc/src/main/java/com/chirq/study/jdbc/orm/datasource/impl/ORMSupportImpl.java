...
import com.chirq.study.jdbc.orm.datasource.orm.OrmDispatcher;
...
public class ORMSupportImpl<T> implements OrmSupport<T> {
    ...
    public T getEntity(Class<T> clazz, Integer id) {
        ...
        try {
            return OrmDispatcher.getOrmConnectionCallback(SqlHelper.SELECT_ENTITY, clazz, id).doInConnection(DBConnectionContextHolder.getDBConnection());
    ...
    public  List<T> getAll(Class<T> clazz) {
        try {
            return (List<T>) OrmDispatcher.getOrmConnectionCallback(SqlHelper.SELECT_ALL, clazz).doInConnection(DBConnectionContextHolder.getDBConnection());
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public  void save(Class<T> clazz, T entity) {
        ...
        try {
            OrmDispatcher.getOrmConnectionCallback(SqlHelper.SAVE, clazz, entity).doInConnection(DBConnectionContextHolder.getDBConnection());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public  void saveOrUpdate(Class<T> clazz, T entity) {
        ...
        try {
            OrmDispatcher.getOrmConnectionCallback(SqlHelper.SAVE_OR_UPDATE, clazz, entity).doInConnection(DBConnectionContextHolder.getDBConnection());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public  void update(Class<T> clazz, T entity) {
        ...
        try {
            OrmDispatcher.getOrmConnectionCallback(SqlHelper.UPDATE, clazz, entity).doInConnection(DBConnectionContextHolder.getDBConnection());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public  void delete(Class<T> clazz, Integer... deleteIds) {
        ...
        try {
            OrmDispatcher.getOrmConnectionCallback(SqlHelper.DELETE, clazz, (Object[]) deleteIds).doInConnection(DBConnectionContextHolder.getDBConnection());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public  void updateField(Class<T> clazz, String field, Object value, Integer... id) {
        ...
        try {
            OrmDispatcher.getOrmConnectionCallback(SqlHelper.UPDATE_FIELD, clazz, clazz, field, value, id).doInConnection(DBConnectionContextHolder.getDBConnection());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
